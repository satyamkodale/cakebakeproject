...
public class ProductDTO {
	    ...
	    private long id;
	    private String name;
		//  private Category category; we can't work directly with category obj in view directly so we created the dto 
		//to handle things 
		//and from here we will take only id of category 
